export default function CoinChancePage() {
  return (
    <div>
      <div
        className=" bg-gradient-to-b from-[#1A1D4D] to-[#070B2B]"
        style={{
          backgroundImage:
      ...
      >
        <header className="flex items-center justify-between px-8 py-4 text-white bg-[#0E1138] shadow-md">
          <div  className="text-xl font-bold">CoinChance</div>
          <nav className="flex items-center gap-4">
          <a href="#presale" className="text-white text-sm hover:text-gray-300 transition duration-300">
          Presale
        </a>
        <a href="/aggregator" className="text-white text-sm hover:text-gray-300 transition duration-300">
          Aggregator
        </a>
        <a href="/play-game" className="text-white text-sm hover:text-gray-300 transition duration-300">
          Play Game
        </a>
            <button className="bg-gradient-to-r from-[#2B1F6B] to-[#674EEB] px-4 py-2 rounded-lg text-sm hover:opacity-90">
              Select Wallet
            </button>
          </nav>
        </header>

        <main className="px-8 py-12 flex flex-col items-start text-left ml-12">
          <h1 className="text-4xl text-white font-bold mb-4">
            Blast Off With Coin Chance
          </h1>
          <p className="text-lg text-gray-300 mb-6">
            Are you ready to drip into the cloud and <br /> see your balance
            rise? Lets drip into success together!
          </p>
          <div className="flex gap-4">
            <button className="bg-gradient-to-r from-[#2B1F6B] to-[#674EEB] px-6 py-3 rounded-lg text-lg hover:opacity-90">
              Play
            </button>
            <button className="bg-gradient-to-r from-[#2B1F6B] to-[#674EEB] px-6 py-3 rounded-lg text-lg hover:opacity-90">
              Join CoinChance
      ...
      <div  className="w-[100%] h-[100%] bg-gradient-to-r from-[#553fd3] to-[#0e0347] ">
        <br />
        <br />
        <br />
        <br />
        <section className="  border-image-source-[radial-gradient(98%_49.86%_at_100.03%_100%,#674EEB_0%,rgba(103,78,235,0.05)_100%),radial-gradient(24.21%_39.21%_at_0%_0%,rgba(255,255,255,0.81)_0%,rgba(255,255,255,0.19)_100%),radial-gradient(21.19%_40.1%_at_100.03%_0%,rgba(0,0,0,0.5)_0%,rgba(0,0,0,0)_100%)] bg-gradient-to-r from-[#2B1F6B] to-[#674EEB] px-8 py-12  rounded-2xl mx-4 md:mx-auto max-w-3xl shadow-2xl backdrop-blur-xl">
          <h2 className="text-2xl font-bold mb-4 text-white ">Current Price</h2>
          <p className="text-gray-300 mb-6">$CHANCE Token: 0.05 USD</p>
        ...
        {/* Giveaway Section */}
        <section id="presale" className="px-8 py-12 mt-12 text-white bg-[#0E1138] rounded-2xl mx-4 md:mx-auto max-w-4xl shadow-xl backdrop-blur-xl">
